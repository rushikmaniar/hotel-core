            ...
            <div class="col-md-12 col-lg-8 main-content">
                ...
                <div class="post-content-body">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12 mb-4 element-animate">
                            <img src="template/assets/images/img_1.jpg" alt="Image placeholder" class="img-fluid">
                        </div>
                        <div class="col-md-6 mb-4 element-animate">
                            <img src="template/assets/images/img_2.jpg" alt="Image placeholder" class="img-fluid">
                        </div>
                        <div class="col-md-6 mb-4 element-animate">
                ...
                <div class="pt-5">
                    ...
                    <ul class="comment-list">
                        <li class="comment">
                            <div class="vcard">
                                <img src="template/assets/images/person_1.jpg" alt="Image placeholder">
                            </div>
                ...
                <div class="sidebar-box">
                    ...
                    <div class="post-entry-sidebar">
                        <ul>
                            <li>
                                <a href="">
                                    <img src="template/assets/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                                    <div class="text">
