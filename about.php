        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="heading-wrap  element-animate">
                    ...
                    <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus illo similique natus, a
        ...
        <div class="row ">
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="template/assets/images/person_1.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
            ...
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="template/assets/images/person_2.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
                        <div class="category">Staff</div>
            ...
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="template/assets/images/person_3.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
