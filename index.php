...
<section class="site-hero overlay" data-stellar-background-ratio="0.5"
         style="background-image: url(template/assets/images/big_image_1.jpg);">
    <div class="container">
...
<section class="site-section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <img src="template/assets/images/f_img_1.png" alt="Image placeholder" class="img-md-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row ">
            <div class="col-md-7">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="template/assets/images/img_1.jpg" alt="Generic placeholder image" class="img-fluid">
            ...
            <div class="col-md-5 room-thumbnail-absolute">
                <a href="#" class="media d-block room bg first-room" style="background-image: url(template/assets/images/img_2.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                  <span>
                    Hotel Room 
                ...
                <a href="#" class="media d-block room bg second-room" style="background-image: url(template/assets/images/img_4.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                  <span>
                    Hotel Room 
...
<section class="section-cover" data-stellar-background-ratio="0.5" style="background-image: url(template/assets/images/img_5.jpg);">
    <div class="container">
        ...
        <div class="row ">
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="template/assets/images/img_3.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
                        <div class="category">Rooms</div>
                        <h3 class="mb-3"><a href="#">New Rooms</a></h3>
                        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum deserunt illo
                            quis similique dolore voluptatem culpa voluptas rerum, dolor totam.</p>
            ...
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="template/assets/images/img_6.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
            ...
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="template/assets/images/img_5.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
